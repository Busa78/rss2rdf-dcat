<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:r="http://backend.userland.com/rss2"
	...
	<xsl:template match="item[guid][not(link)]|r:item[r:guid][not(r:link)]"
		mode="rdfitem">
